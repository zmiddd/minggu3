                    ...
                    <div class="col-lg-6 col-md-6">
                            ...
                            <div class="crsl-items" data-navigation="navbtns">
                                <div class="crsl-wrap">
                                    <figure class="crsl-item">
                                        <img src="{{ asset('multi/img/1.jpg') }}" alt="Image" class="img-responsive img-thumbnail">
                                    </figure>
                                    <figure class="crsl-item">
                                        <img src="{{ asset('multi/img/2.jpg') }}" alt="Image" class="img-responsive img-thumbnail">
                                    </figure>
                                    <figure class="crsl-item">
                                        <img src="{{ asset('multi/img/3.jpg') }}" alt="Image" class="img-responsive img-thumbnail">
                                    </figure>
                                </div>
                            </div>
                        ...
                        <div id="navbtns" class="crsl-nav">
                            <a href="#" class="previous">
                                <img src="{{ asset('multi/img/carousel-arrow-previous.png') }}" alt="previous">
                            </a>
                            <a href="#" class="next">
                                <img src="{{ asset('multi/img/carousel-arrow-next.png') }}" alt="next">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <div class="tm-blocks-container effect1">
                            ...
                            <div class="tm-block">
                                <img src="{{ asset('multi/img/4.jpg') }}" alt="Image" class="img-responsive">
                            </div>
                            <div class="tm-block">
                                <img src="{{ asset('multi/img/5.jpg') }}" alt="Image" class="img-responsive">
                            </div>
                            ...
                            <div class="tm-block">
                                <img src="{{ asset('multi/img/6.jpg') }}" alt="Image" class="img-responsive">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row posts-container">
                    <div class="post-excerpt post-excerpt-left">
                        ...
                        <div class="post-arrow-container rotate-arrow">
                            <img src="{{ asset('multi/img/blog-arrow.png') }}" alt="arrow">
                        </div>
                    </div>
